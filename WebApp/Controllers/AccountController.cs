    ...
    public class AccountController : BaseController
    {
            ...
            if (!Request.IsAuthenticated)
            {
                ...
                else
                {
                    if (transacciones.Count > 0)
                    {
                        ...
                        var claims = GetClaims(model, Request, transacciones, usuario, (string)faceid);
                        if (claims != null)
                        {
                            SignIn(claims);
                            Session["menu"] = null;
        ...
        public ActionResult Register(Usuario usuario)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                securityDao.inserUsuario(usuario, GetApplicationUser(), ref mensaje);
        ...
        private List<Claim> GetClaims(LoginViewModel model, HttpRequestBase request, List<string> roles, Usuario usuario, string faceid)
        {
